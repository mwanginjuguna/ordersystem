...
<head>
    ...
    <title>New Message Notification ~ {{ env('APP_NAME') ?? 'Order System' }}</title>
...
<main>
    <div class="table-div"
        ...
        <p style="margin: 50px auto auto;">Dear {{ $data['username'] ?? 'User' }},<br>
            {!! $data['content'] !!}
        </p>
    ...
    <div class="email-credits">
        <b>© {{ now()->year }} Property of {{ env('APP_NAME') }}. All rights reserved.</b>
    </div>
</main>
</body>
</html>
