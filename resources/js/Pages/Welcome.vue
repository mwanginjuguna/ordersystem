...
<template>
    ...
    >
        <div v-if="canLogin" class="hidden min-w-full sticky top-0 right-0 px-6 py-4 sm:block">
            <Link
        ...
        <div class="sm:px-6 lg:px-12 py-4 lg:py-12">
            <div class="max-w-7xl grid lg:grid-cols-3 h-full pt-8 sm:pt-0 gap-2">
                <div class="pb-10 px-8 lg:col-span-2">
                    <h1 class="text-center lg:text-left text-3xl  lg:text-5xl text-slate-700 font-extrabold font-serif uppercase">Technical Case Study Experts</h1>
                    ...
                    <div class="mt-9">
                        <p class="text-slate-600 text-lg font-medium">Trusted by <span class="text-xl font-bold text-purple-900">12K+</span>happy customers.</p>
            ...
            <div class="mt-36 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Create a new order as a guest using clientController
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="/email-test" class="underline text-gray-900 dark:text-white"
                                    >Email Tests</a
                                >
                            </div>
                        </div>
